  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="testimonials w-slider"
        data-autoplay="false"
        data-easing="ease"
        style={{
          opacity: 1,
        ...
        data-w-id="41c5f9d9-4151-e07e-b783-9b550f20099b"
        ...
        aria-label="carousel"
      >
        <div className="mask-testimonials w-slider-mask" id="w-slider-mask-1">
          <div
            ...
            <div aria-hidden="true">
              <div className="testimonial-heading" aria-hidden="true">
                ...
                <div className="expand-center" aria-hidden="true">
                  <div aria-hidden="true">
                    <div className="title-semi-bold medium" aria-hidden="true">
                      Laura Sheen
                    </div>
                    <div aria-hidden="true">
        ...
        <div
          data-w-id="41c5f9d9-4151-e07e-b783-9b550f2009e5"
          style={{
            opacity: 1,
            transform:
              "translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)",
          ...
          className="slide-left-arrow w-slider-arrow-left"
          role="button"
          tabIndex={0}
        ...
        <div
          data-w-id="41c5f9d9-4151-e07e-b783-9b550f2009e7"
          style={{
            opacity: 1,
            transform:
              "translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)",
          ...
          className="slide-right-arrow w-slider-arrow-right"
          role="button"
          tabIndex={0}
          aria-controls="w-slider-mask-1"
